...
public class Example {
    public static void main(String[] args) {
        ...
        FieldConfigurationSchemeProjectAssociation fieldConfigurationSchemeProjectAssociation = {"fieldConfigurationSchemeId":"10000","projectId":"10000"}; // FieldConfigurationSchemeProjectAssociation | 
        try {
