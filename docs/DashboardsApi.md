...
public class Example {
    public static void main(String[] args) {
        ...
        DashboardDetails dashboardDetails = {"name":"Auditors dashboard","description":"A dashboard to help auditors identify sample of issues to check.","sharePermissions":[{"type":"global"}]}; // DashboardDetails | Dashboard details.
        try {
...
public class Example {
    public static void main(String[] args) {
        ...
        DashboardDetails dashboardDetails = {"name":"Auditors dashboard","description":"A dashboard to help auditors identify sample of issues to check.","sharePermissions":[{"type":"global"}]}; // DashboardDetails | Replacement dashboard details.
        try {
