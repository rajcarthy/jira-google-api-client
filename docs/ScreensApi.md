...
public class Example {
    public static void main(String[] args) {
        ...
        ScreensApi apiInstance = new ScreensApi(defaultClient);
        ScreenDetails screenDetails = {"name":"Resolve Security Issue Screen","description":"Enables changes to resolution and linked issues."}; // ScreenDetails | 
        try {
...
public class Example {
    public static void main(String[] args) {
        ...
        ScreensApi apiInstance = new ScreensApi(defaultClient);
        Long screenId = 56L; // Long | The ID of the screen.
        UpdateScreenDetails updateScreenDetails = {"name":"Resolve Accessibility Issue Screen","description":"Enables changes to resolution and linked issues for accessibility related issues."}; // UpdateScreenDetails | 
        try {
